#include "quickgitconstants.h"
#include "quickgittr.h"
...
namespace QuickGit::Internal {

class QuickGitPlugin final : public ExtensionSystem::IPlugin
{
	Q_OBJECT
	Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QtCreatorPlugin" FILE "QuickGit.json")

public:
	QuickGitPlugin() = default;

	~QuickGitPlugin() final
	{
	...
	void initialize() final
	{
		...
		menu->menu()->setTitle(Tr::tr("QuickGit"));
		ActionManager::actionContainer(Core::Constants::M_TOOLS)->addMenu(menu);

		ActionBuilder(this, Constants::ACTION_ID)
				.addToContainer(Constants::MENU_ID)
				.setText(Tr::tr("QuickGit Action"))
				.setDefaultKeySequence(Tr::tr("Ctrl+Alt+Meta+A"))
				.addOnTriggered(this, &QuickGitPlugin::triggerAction);
	}
	...
	void extensionsInitialized() final
	{
		...
		layout->addWidget(new QPushButton("Commit"));
		layout->addWidget(new QPushButton("Push"));
		layout->addWidget(new QPushButton("Pull"));

		auto *dock = new QDockWidget("QuickGit");
...
private:
	void triggerAction()
	{
		QMessageBox::information(ICore::dialogParent(),
								 ...
								 Tr::tr("This is an action from QuickGit."));
	}
};

} // namespace QuickGit::Internal

#include <quickgit.moc>
